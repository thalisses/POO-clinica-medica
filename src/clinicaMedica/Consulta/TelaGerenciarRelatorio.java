 ...
 * @author User
 */
public class TelaGerenciarRelatorio extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGerenciarRelatorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

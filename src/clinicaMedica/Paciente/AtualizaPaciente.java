...
public class AtualizaPaciente extends javax.swing.JPanel {
    ...
    private void salvarAlteracoesButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            // 4. Atualiza Convênio
            Object selectedItem = tipoConvenioBox.getSelectedItem();
            if (selectedItem instanceof Paciente.tiposConvenios) {
                pacienteEmEdicao.setConvenio((Paciente.tiposConvenios) selectedItem);
            } else if (selectedItem instanceof String) {
                // Se for String, converte para o enum
                String convenioStr = (String) selectedItem;
                // Trata os diferentes formatos possíveis
                if (convenioStr.equalsIgnoreCase("Particular") || convenioStr.equalsIgnoreCase("PARTICULARES")) {
                    pacienteEmEdicao.setConvenio(Paciente.tiposConvenios.PARTICULARES);
                } else if (convenioStr.equalsIgnoreCase("Plano de Saúde") || convenioStr.equalsIgnoreCase("PLANO_DE_SAUDE")) {
                    pacienteEmEdicao.setConvenio(Paciente.tiposConvenios.PLANO_DE_SAUDE);
                } else {
                    // Tenta conversão direta
                    pacienteEmEdicao.setConvenio(Paciente.tiposConvenios.valueOf(convenioStr.toUpperCase()));
                }
            }
